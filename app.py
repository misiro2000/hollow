...
st.title('営業情報管理システム')import streamlit as st
import pandas as pd
import os
from datetime import datetime
...
if df.empty:
    ...
    if page == '営業情報の入力':
        ...
        if submit_button:
            new_data = {'日付': date_input, '地名': district_input, '時間': time_input.strftime('%H:%M'),
                        '金額': amount_input, '支払い形態': payment_method_input}
